...
type Client interface {
	...
	GenerateContentByImage(ctx context.Context, input []byte) (string, error)
	Close()
}
...
func (c client) GenerateContentByImage(ctx context.Context, input []byte) (string, error) {
